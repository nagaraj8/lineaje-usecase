...
public class FamilyOrderingServiceTest {
	...
	static void setUpBeforeClass() throws Exception {
		underTest = new FamilyOrderingService("src\\test\\resources\\familyTree.json");
	}
	...
	void testProcessFamilyData() throws Exception {
		...
		Assert.assertEquals(FileUtils.readLines(new File("src\\test\\resources\\FamilyOrdering.txt")), FileUtils.readLines(new File("FamilyOrdering.txt")));
	}
