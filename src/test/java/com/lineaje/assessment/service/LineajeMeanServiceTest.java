...
public class LineajeMeanServiceTest {
	...
	static void setUpBeforeClass() throws Exception {
		underTest = new LineajeMeanService("src\\test\\resources\\familyTree.json");
	}
	...
	void testProcessFamilyData() throws Exception {
		...
		Assert.assertEquals(FileUtils.readLines(new File("src\\test\\resources\\LineajeMean.txt")), FileUtils.readLines(new File("LineajeMean.txt")));
	}
