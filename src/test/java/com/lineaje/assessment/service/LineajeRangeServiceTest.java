...
public class LineajeRangeServiceTest {
	...
	static void setUpBeforeClass() throws Exception {
		underTest = new LineajeRangeService("src\\test\\resources\\familyTree.json");
	}
	...
	void testProcessFamilyData() throws Exception {
		...
		Assert.assertEquals(FileUtils.readLines(new File("src\\test\\resources\\LineajeRange.txt")), FileUtils.readLines(new File("LineajeRange.txt")));
	}
