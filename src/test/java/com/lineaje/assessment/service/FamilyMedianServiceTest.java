...
public class FamilyMedianServiceTest {
	...
	static void setUpBeforeClass() throws Exception {
		underTest = new FamilyMedianService("src\\test\\resources\\familyTree.json");
	}
	...
	void testProcessFamilyData() throws Exception {
		...
		Assert.assertEquals(FileUtils.readLines(new File("src\\test\\resources\\LineajeMedian.txt")), FileUtils.readLines(new File("LineajeMedian.txt")));
